...
class MatchVisitTemplate(ABC):
    ...
    def process_visit(self, player_index, visit):
        ...
        The Templace Method defines a skeleton of an algorithm in an operation, and defers some steps to subclasses."""
        ...
        #Note: this violates the separation of concerns principle (we are mixing presentation login in
    ...
    def validate_visit(self, player_index, visit):
        """ Primitive operation. You HAVE TO override me, im a placeholder """
        pass
